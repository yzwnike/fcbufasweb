...
// Achievement definitions (reduced for count calculation)
const ACHIEVEMENTS = [
  { key: 'fantasy_jornadas', thresholds: [3,5,10,15,20] },
  { key: 'cartas_totales', thresholds: [5,10,20,30,40,50,75,100] },
  { key: 'cartas_distintas', thresholds: [5,10,15,20,30,40,50] },
  { key: 'sbc_completados', thresholds: [1,3,5,10] },
  { key: 'mercado_compras', thresholds: [3,5,10,20] },
  { key: 'mercado_ventas', thresholds: [3,5,10,20] },
  { key: 'sobres_abiertos', thresholds: [5,10,20,30,40,50] },
  { key: 'quiz_aciertos', thresholds: [10,20,30,40,50,75,100] },
];
...
export const GET: APIRoute = async ({ request }) => {
  try {
    ...
    return new Response(JSON.stringify({ success: true, count: pendingCount }), { status: 200 });
  } catch (e) {
    console.error('Error en achievements count:', e);
